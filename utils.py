# -----------------------------------------------------------------------------------------
# **Attribution:**
This implementation is based on code originally taken from the Keras-OpenFace project:
[https://github.com/iwantooxxoox/Keras-OpenFace](https://github.com/iwantooxxoox/Keras-OpenFace)

The code has been adapted and modified to suit the requirements of this project.
# -----------------------------------------------------------------------------------------
